...
.. |commits-since| image:: https://img.shields.io/github/commits-since/zoloft/python-spihole/v0.0.0.svg
    :alt: Commits since latest release
    :target: https://github.com/zoloft/python-spihole/compare/v0.0.0...master
